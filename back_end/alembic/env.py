...
Reads DATABASE_URL from app settings (not alembic.ini) so the same
connection string is used by the API and migrations.
"""
import asyncio
...
# Import the app settings and Base for autogeneration.
...
# Convert asyncpg URL to async URL for Alembic.
